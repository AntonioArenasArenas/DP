...
@Controller
@RequestMapping("/complaint/worker")
public class ComplaintWorkerController extends AbstractController {
...
public ComplaintWorkerController() {
	super();
}
	// Listing ----------------------------------------------------------------
	...
	public ModelAndView list() {
		...
		result.addObject("requestURI", "complaint/worker/list.do");
